...
class HelpdeskTicketInherit(models.Model):
    ...
    canal_type = fields.Many2one('res.canales', string='Canal', store=True)
    clasificacion_ticket = fields.Many2one('clasificacion.ticket', string='Clasificación', store=True)
